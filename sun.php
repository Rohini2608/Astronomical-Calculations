...
//recent update
        //to cancel the minus sign

        if ($moonmandacorrectionmin<0) {
          # code...
          $moonmandacorrectionmin1=-($moonmandacorrectionmin);
        }
        else{
          $moonmandacorrectionmin1=$moonmandacorrectionmin;
        }
     ...
     //true mean sun
        ...
        if ($moonmandakendra>180) {
          # code...
          if ($moonfinaldeg<360) {
            # code...
            $moonfinaldeg1=$moonfinaldeg+360;

            $moonsundeg=$moonfinaldeg1-$moonmandacorrectionmin1;
          ...
          $moonsundeg=$moonfinaldeg+$moonmandacorrectionmin1;
        }
